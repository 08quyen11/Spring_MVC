...
INSERT INTO `language` (`languageId`, `language`, `isDeleted`) VALUES ('fr', 'French', b'0');
SELECT * FROM language;
USE translation;
INSERT INTO `producttranslation` (`productID`, `languageID`, `productName`, `productDescription`, `isDeleted`)
VALUES
    (2, 'fr', 'Télévision 360', 'Ceci est une télévision 360 pouces', b'0'),
    (3, 'fr', 'Télévision 400', 'Ceci est une télévision 400 pouces', b'0');
    USE translation;
INSERT INTO `productcategorytranslation` (`productCategoryID`, `languageID`, `categoryName`, `isDeleted`)
VALUES
    (1, 'fr', 'Télévision', b'0'),
    (2, 'fr', 'Ordinateur portable', b'0');